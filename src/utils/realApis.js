/**
 * @module realApis
 * @description Real free-API integrations for StadiumIQ 2026.
 *
 * Provides weather, air quality, sun times, crowd simulation, and
 * live match data. Static venue data lives in src/data/stadiums.js
 * so this module has a single responsibility: API fetch logic only.
 *
 * All external services used here are free and require no API key
 * (football-data.org is optional — enables live WC 2026 match data).
 */

// Re-export from dedicated data module — no other import sites need changing
export { STADIUMS, STADIUMS_MAP } from '../data/stadiums';
